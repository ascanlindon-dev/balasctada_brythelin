...
<head>
    ...
    <title>Add Product - CRAFTIFY Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                ...
                <p>Create a new product for your CRAFTIFY platform</p>
            </div>
            ...
            <form action="<?= site_url('admin/do_add_product') ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-textarea" placeholder="Describe your product..."></textarea>
                </div>
